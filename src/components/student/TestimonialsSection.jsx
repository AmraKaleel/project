...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
        <h2 className='text-3xl font-medium text-gray-800'>Tastimonials</h2>
        <p className='md:text-base text-gray-500 mt-3'>Here from our learners as they share their journey of transformation, success, and hiw our<br/>platform has made a difference in their lives.</p>
